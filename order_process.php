      ...
      <div class="row">
       <div class="col-md-8" style="border-right:1px solid #ddd;">
              ...
              <div class="form-group">
                 <div class="row">
                  <div class="col-md-4">
                   ...
                   class="form-control" placeholder="MM" maxlength="2" onkeypress="return only_number(event);" />
                  ...
                  <div class="col-md-4">
                   ...
                   class="form-control"
                    placeholder="YYYY" maxlength="4" onkeypress="return only_number(event);" />
        ...
        <div align="center">
         ...
         <input type="button" name="button_action" 
         id="button_action" class="btn btn-success btn-sm" 
